...
export const ACHIEVEMENTS = [
  ...
  { id:"earn50",       label:"Fossil Collector",        desc:"Earn 50 fossils total",                  req:(s)=>s.totalBones>=50,     reward:15,  tier:"bronze" },
  ...
  { id:"earn500",      label:"Fossil Hunter",          desc:"Earn 500 fossils total",                req:(s)=>s.totalBones>=500,    reward:75,  tier:"silver" },
  ...
  { id:"use_shield_100",label:"Bubble Boy",            desc:"Use Shield powerup 100 times",          req:(s)=>(s.powerupUses?.shield_pw||0)>=100,  reward:150, tier:"silver" },
  ...
  { id:"playtime1h",   label:"Just One More Run",      desc:"Spend 1 hour playing",                  req:(s)=>(s.totalPlayTime||0)>=3600,   reward:300, tier:"gold" },
  ...
  { id:"passive100",   label:"The Idle One",           desc:"Earn 100 fossils passively in one session",req:(s)=>s.passiveEarned>=100,reward:1500,tier:"legend" },
  ...
  { id:"untouchable",  label:"Are You Even Real?",     desc:"Run 20,000m without taking a single hit or activating a shield", req:(s)=>s.bestDistNoHit>=20000, reward:50000,tier:"impossible" },
                  ...
                  return (
                    <div key={a.id} style={{ background:done?"#faf8f4":"#ebe8e2", border:`1px solid ${done?tierColors[a.tier]:"#ccc"}`, padding:"10px", boxSizing:"border-box", opacity:done?1:0.5 }}>
                      ...
                      <div style={{ fontSize:9, color:done?tierColors[a.tier]:MUTED, fontWeight:"bold" }}>
                        {done ? "UNLOCKED" : `+${a.rewardLabel || `${a.reward} fossils`}`}
                      </div>
                    </div>
                  );
                })}
