...
export function drawDilopho(ctx, x, y, dead, c, ec, ac, fc, isDucking, f) {
  if (isDucking) {
    ...
    if (!dead) {
      if (f === 0) {
        ctx.fillRect(x+8,  y+36, 7, 7); ctx.fillRect(x+6,  y+43, 6, 5); ctx.fillRect(x+5,  y+46, 9, 2);
        ctx.fillRect(x+20, y+36, 7, 4); ctx.fillRect(x+22, y+40, 6, 5); ctx.fillRect(x+21, y+44, 9, 2);
      } else {
        ctx.fillRect(x+8,  y+36, 7, 4); ctx.fillRect(x+10, y+40, 6, 5); ctx.fillRect(x+9,  y+44, 9, 2);
        ctx.fillRect(x+20, y+36, 7, 7); ctx.fillRect(x+18, y+43, 6, 5); ctx.fillRect(x+17, y+46, 9, 2);
      }
    } else {
